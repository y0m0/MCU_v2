...
Use both "Detailed Product List" and a "Discount per customer" reports to generate a XML catalog file 
whith update prices and discounts based on specific customers, and then uploads it to the FTP server.
